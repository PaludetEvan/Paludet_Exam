...
export default async function Handler (req,res) {
    ...
    if (req.method === 'GET') {
        try {
            ...
            const result = await client.query('SELECT * FROM richieste_accettate WHERE id = $1', [id])
        ...
        try {
          ...
          const result = await pool.query('DELETE FROM richieste_accettate WHERE id = $1 RETURNING *', [id]);
